...
/**
 * Modelo del módulo autores, en esta clase se hacen todas las consultas
 * relacionadas con la gestión de autores, extiende del core del modelo
...
class Autores_model extends CI_Model {
	 ...
	 * @return true/false         true si la consulta tiene éxito, false si falla.
	 */
